        ...
        try {
          ...
          const uploadResponse = await axios.post(upload_url, formData, {
            ...
            onUploadProgress: (progressEvent) => {
              // Bug #37 fix: progressEvent.total can be undefined when the server
              // uses chunked transfer encoding without Content-Length.
              const total = progressEvent.total;
              if (!total) return; // can't compute percentage
